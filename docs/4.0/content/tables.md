...
layout: docs
title: Tables
description: Documentation and examples for opt-in styling of tables (given their prevalent use in JavaScript plugins) with Melodic.
group: content
toc: true
---
...
Using the most basic table markup, here's how `.table`-based tables look in Melodic. **All table styles are inherited in Melodic**, meaning any nested tables will be styled in the same manner as the parent.
