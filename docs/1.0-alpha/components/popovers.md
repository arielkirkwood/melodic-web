...
layout: docs
title: Popovers
description: Documentation and examples for adding Melodic popovers, like those found in iOS, to any element on your site.
group: components
toc: true
---
...
- Popovers rely on the 3rd party library [Popper.js](https://popper.js.org/) for positioning. You must include [popper.min.js]({{ site.cdn.popper }}) before melodic.js or use `melodic.bundle.min.js` / `melodic.bundle.js` which contains Popper.js in order for popovers to work!
