...
We inherited this list from Bootstrap, and will update it accordingly as these bugs are squashed. For information on Melodic's browser compatibility, [see our browser compatibility docs]({{ site.baseurl }}/docs/{{ site.docs_version }}/getting-started/browsers-devices/#supported-browsers).
...
<table class="mwd-browser-bugs table table-bordered table-hover">
  <thead>
    <tr>
      <th>Browser(s)</th>
