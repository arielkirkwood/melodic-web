...
layout: docs
title: Typography
description: Documentation and examples for Melodic typography, including global settings, headings, body text, lists, and more.
group: content
toc: true
---
...
Melodic sets basic global display, typography, and link styles. When more control is needed, check out the [textual utility classes]({{ site.baseurl }}/docs/{{ site.docs_version }}/utilities/text/).
...
{% highlight html %}
<h1>h1. Melodic heading</h1>
<h2>h2. Melodic heading</h2>
<h3>h3. Melodic heading</h3>
<h4>h4. Melodic heading</h4>
<h5>h5. Melodic heading</h5>
<h6>h6. Melodic heading</h6>
{% endhighlight %}

`.h1` through `.h6` classes are also available, for when you want to match the font styling of a heading but cannot use the associated HTML element.

{% example html %}
<p class="h1">h1. Melodic heading</p>
<p class="h2">h2. Melodic heading</p>
<p class="h3">h3. Melodic heading</p>
<p class="h4">h4. Melodic heading</p>
<p class="h5">h5. Melodic heading</p>
<p class="h6">h6. Melodic heading</p>
{% endexample %}
...
*Responsive typography* refers to scaling text and components by simply adjusting the root element's `font-size` within a series of media queries. Melodic doesn't do this for you, but it's fairly easy to add if you need it.
