module Jekyll
  module BugFilter
    def bugify(input)
      upstream_map = {
        "Melodic": "https://github.com/DWPHoldings/melodic-web/issues/",
        ...
        "A11yUserVoice": ["https://microsoftaccessibility.uservoice.com/forums/307429-microsoft-accessibility-feedback/suggestions/",
